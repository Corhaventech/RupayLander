...
import FeeschargesDetalis from "./FeeschargesDetalis";
  ...
  return (
    <ImageBackground source={bgImg} style={styles.backggroundContainer}>
      ...
      <View style={styles.buttonContainer}>
        <Pressable style={styles.Download} onPress={() => navigation.navigate('AddCustomerCreate')}>
          <Text style={{ fontSize: 14, fontWeight: '500' }}>Add Customer</Text>
        </Pressable>
