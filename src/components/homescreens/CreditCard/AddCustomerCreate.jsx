    ...
    return (
        <ImageBackground source={bgImg} style={styles.backggroundContainer}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View>
                    <Text style={{ fontWeight: '500', color: '#3B3935' }}>Annual Income</Text>
                    <DropDownPicker
                        style={styles.inputNumber}
                        open={open1}
                        value={value1}
                ...
                <View>
                    <Text style={{ fontWeight: '500', color: '#3B3935' }}>Do you have a credit card?</Text>
                    <DropDownPicker
                        style={styles.inputNumber}
                        open={open2}
                        value={value2}
...
export default AddCustomerCreate
